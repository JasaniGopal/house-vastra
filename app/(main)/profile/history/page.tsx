        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white p-5 md:p-6 rounded-2xl border border-[#c1c8c5]/40 shadow-sm flex flex-col md:flex-row gap-6">
            ...
            <div className="relative w-full md:w-28 h-40 md:h-28 rounded-xl overflow-hidden bg-zinc-100 shrink-0 border border-zinc-100 opacity-80 mix-blend-multiply">
               <Image 
                src="/images/home/trending-home-2.jpg" 
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              <div className="flex flex-wrap items-center gap-3 mt-4">
                <button onClick={() => showToast("Added Pastel Floral Silk Saree to Bag!")} className="bg-[#FAF2E8] text-[#775a19] py-2 px-5 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-[#F6EDDB] transition-all">
                  Rent Again
                </button>
                <button onClick={() => showToast("Downloading Invoice RV-84920.pdf...")} className="border border-zinc-200 text-zinc-600 bg-white py-2 px-5 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-zinc-50 transition-all">
                  View Invoice
                </button>
              </div>
            </div>
          ...
          <div className="bg-white p-5 md:p-6 rounded-2xl border border-[#c1c8c5]/40 shadow-sm flex flex-col md:flex-row gap-6">
            ...
            <div className="relative w-full md:w-28 h-40 md:h-28 rounded-xl overflow-hidden bg-zinc-100 shrink-0 border border-zinc-100 opacity-80 mix-blend-multiply">
               <Image 
                src="/images/home/bag_gold_sherwani.png" 
            ...
            <div className="flex-1 flex flex-col justify-between">
              ...
              {/* Actions */}
              <div className="flex flex-wrap items-center gap-3 mt-4">
                <button onClick={() => showToast("Added Ivory & Gold Sherwani Set to Bag!")} className="bg-[#FAF2E8] text-[#775a19] py-2 px-5 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-[#F6EDDB] transition-all">
                  Rent Again
                </button>
                <button onClick={() => showToast("Downloading Invoice RV-71023.pdf...")} className="border border-zinc-200 text-zinc-600 bg-white py-2 px-5 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-zinc-50 transition-all">
                  View Invoice
                </button>
              </div>
            </div>
