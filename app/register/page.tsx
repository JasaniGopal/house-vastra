...
export default function RegisterPage() {
  ...
  const handleVerifyOtpAndRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Automatically redirect to home after successful registration/login
    ...
    <div className="min-h-screen flex flex-col justify-between bg-[#fcf9f8] text-[#1c1b1b] font-sans">
      ...
      <div className="mx-auto max-w-[420px] w-full px-6 py-6 flex-grow flex flex-col justify-center">
          ...
          <form onSubmit={handleRequestOtp} className="space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-xs md:text-sm">
                <label htmlFor="agree" className="font-sans text-zinc-500 leading-normal">
                  I agree to the{" "}
                  <Link href="/terms" className="font-semibold text-[#001410] underline hover:text-[#775a19] transition-colors">
                    Terms & Conditions
                  </Link>{" "}
                  and{" "}
                  <Link href="/privacy" className="font-semibold text-[#001410] underline hover:text-[#775a19] transition-colors">
                    Privacy Policy
                  </Link>
                  .
                </label>
        ...
        <p className="mt-8 text-center text-xs md:text-sm font-sans text-zinc-500">
          ...
          <Link href="/login" className="font-bold text-[#001410] hover:text-[#775a19] transition-colors">
            Login
          </Link>
        </p>
